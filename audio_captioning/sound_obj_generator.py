...
def get_chat_gpt_answers(prompt_1,
                         prompt_2,
                         answer_1,
                         temperature,
                         system_behavior_message=None):
...
def get_additional_kws(keywords,
                       m_variations_wanted,
                       temperature):
    ...
    response = get_chat_gpt_answers(prompt_1="Create " + str(m_variations_wanted) + " variations of each object in the following list of audio tags,\
                                ...
                                prompt_2="Do the same for every object in the list: " + str(keywords) + ". Append them to one Python list and only\
...
if __name__ == '__main__':
    ...
    print('{} variations wanted, {} sounding objects per batch and ChatGPT Temperature = {}'.format(m_variations_wanted, l_sounding_objects_per_batch, temperature))
    ...
    with parallel_backend("multiprocessing"):
        ...
        delayed(get_additional_kws)(batch,
                                    m_variations_wanted,
                                    temperature

...
def create_dicts(in_f, split_name, filepath):
    ...
    data = raw_data.groupby(['youtube_id', 'start_time'])['caption'].apply(list).reset_index()
...
if __name__ == '__main__':
    ...
    splits = {split_name:create_dicts(in_f, split_name=split_name, filepath="WHAT_IS_THIS?") for split_name in ["train", "val", "test"]}

    print ('Number of train instance {}, val instances {}, and test instances {}'.format(len(splits["train"]),
